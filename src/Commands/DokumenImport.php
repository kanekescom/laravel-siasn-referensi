...
use Kanekescom\SiasnReferensi\Services\DokumenDataset;

class DokumenImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:dokumen-ref';
     ...
     * @var string
     */
    protected $description = 'Import dokumen reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(DokumenRepository::class);
        $repository->deleteAll();
        $data = DokumenDataset::get();
