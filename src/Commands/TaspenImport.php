...
use Kanekescom\SiasnReferensi\Services\TaspenDataset;

class TaspenImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:taspen-ref';
     ...
     * @var string
     */
    protected $description = 'Import taspen reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(TaspenRepository::class);
        $repository->deleteAll();
        $data = TaspenDataset::get();
