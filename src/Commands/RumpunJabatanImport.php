...
use Kanekescom\SiasnReferensi\Services\RumpunJabatanDataset;

class RumpunJabatanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:rumpun-jabatan-ref';
     ...
     * @var string
     */
    protected $description = 'Import rumpun jabatan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(RumpunJabatanRepository::class);
        $repository->deleteAll();
        $data = RumpunJabatanDataset::get();
