...
use Kanekescom\SiasnReferensi\Services\JenisKepanitiaanDataset;

class JenisKepanitiaanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-kepanitiaan-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis kepanitiaan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisKepanitiaanRepository::class);
        $repository->deleteAll();
        $data = JenisKepanitiaanDataset::get();
