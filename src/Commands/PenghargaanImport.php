...
use Kanekescom\SiasnReferensi\Services\PenghargaanDataset;

class PenghargaanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:penghargaan-ref';
     ...
     * @var string
     */
    protected $description = 'Import penghargaan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(PenghargaanRepository::class);
        $repository->deleteAll();
        $data = PenghargaanDataset::get();
