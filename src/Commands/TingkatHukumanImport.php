...
use Kanekescom\SiasnReferensi\Services\TingkatHukumanDataset;

class TingkatHukumanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:tingkat-hukuman-ref';
     ...
     * @var string
     */
    protected $description = 'Import tingkat hukuman reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(TingkatHukumanRepository::class);
        $repository->deleteAll();
        $data = TingkatHukumanDataset::get();
