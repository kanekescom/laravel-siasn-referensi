...
use Kanekescom\SiasnReferensi\Services\JenisHukumanDataset;

class JenisHukumanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-hukuman-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis hukuman reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisHukumanRepository::class);
        $repository->deleteAll();
        $data = JenisHukumanDataset::get();
