...
use Kanekescom\SiasnReferensi\Services\JabatanFungsionalDataset;

class JabatanFungsionalImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jabatan-fungsional-ref';
     ...
     * @var string
     */
    protected $description = 'Import jabatan fungsional reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JabatanFungsionalRepository::class);
        $repository->deleteAll();
        $data = JabatanFungsionalDataset::get();
