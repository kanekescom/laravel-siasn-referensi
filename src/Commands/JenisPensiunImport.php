...
use Kanekescom\SiasnReferensi\Services\JenisPensiunDataset;

class JenisPensiunImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-pensiun-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis pensiun reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisPensiunRepository::class);
        $repository->deleteAll();
        $data = JenisPensiunDataset::get();
