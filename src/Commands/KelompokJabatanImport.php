...
use Kanekescom\SiasnReferensi\Services\KelompokJabatanDataset;

class KelompokJabatanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:kelompok-jabatan-ref';
     ...
     * @var string
     */
    protected $description = 'Import kelompok jabatan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(KelompokJabatanRepository::class);
        $repository->deleteAll();
        $data = KelompokJabatanDataset::get();
