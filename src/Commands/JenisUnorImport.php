...
use Kanekescom\SiasnReferensi\Services\JenisUnorDataset;

class JenisUnorImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-unor-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis unor reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisUnorRepository::class);
        $repository->deleteAll();
        $data = JenisUnorDataset::get();
