...
use Kanekescom\SiasnReferensi\Services\JenisKursusDataset;

class JenisKursusImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-kursus-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis kursus reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisKursusRepository::class);
        $repository->deleteAll();
        $data = JenisKursusDataset::get();
