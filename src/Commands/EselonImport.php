...
use Kanekescom\SiasnReferensi\Services\EselonDataset;

class EselonImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:eselon-ref';
     ...
     * @var string
     */
    protected $description = 'Import eselon reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(EselonRepository::class);
        $repository->deleteAll();
        $data = EselonDataset::get();
