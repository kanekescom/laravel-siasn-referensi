...
use Kanekescom\SiasnReferensi\Services\PendidikanDataset;

class PendidikanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:pendidikan-ref';
     ...
     * @var string
     */
    protected $description = 'Import pendidikan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(PendidikanRepository::class);
        $repository->deleteAll();
        $data = PendidikanDataset::get();
