...
use Kanekescom\SiasnReferensi\Services\AgamaDataset;

class AgamaImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Import agama reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(AgamaRepository::class);
        $repository->deleteAll();
        $data = AgamaDataset::get();
