...
use Kanekescom\SiasnReferensi\Services\JenisIdDokumenDataset;

class JenisIdDokumenImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-id-dokumen-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis id dokumen reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisIdDokumenRepository::class);
        $repository->deleteAll();
        $data = JenisIdDokumenDataset::get();
