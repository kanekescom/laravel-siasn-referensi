...
use Kanekescom\SiasnReferensi\Services\KedudukanHukumDataset;

class KedudukanHukumImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:kedudukan-hukum-ref';
     ...
     * @var string
     */
    protected $description = 'Import kedudukan hukum reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(KedudukanHukumRepository::class);
        $repository->deleteAll();
        $data = KedudukanHukumDataset::get();
