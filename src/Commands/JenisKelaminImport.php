...
use Kanekescom\SiasnReferensi\Services\JenisKelaminDataset;

class JenisKelaminImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-kelamin-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis kelamin reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisKelaminRepository::class);
        $repository->deleteAll();
        $data = JenisKelaminDataset::get();
