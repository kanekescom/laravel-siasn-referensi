...
use Kanekescom\SiasnReferensi\Services\TingkatPendidikanDataset;

class TingkatPendidikanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:tingkat-pendidikan-ref';
     ...
     * @var string
     */
    protected $description = 'Import tingkat pendidikan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(TingkatPendidikanRepository::class);
        $repository->deleteAll();
        $data = TingkatPendidikanDataset::get();
