...
use Kanekescom\SiasnReferensi\Services\InstansiDataset;

class InstansiImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:instansi-ref';
     ...
     * @var string
     */
    protected $description = 'Import instansi reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(InstansiRepository::class);
        $repository->deleteAll();
        $data = InstansiDataset::get();
