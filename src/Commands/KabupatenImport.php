...
use Kanekescom\SiasnReferensi\Services\KabupatenDataset;

class KabupatenImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:kabupaten-ref';
     ...
     * @var string
     */
    protected $description = 'Import kabupaten reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(KabupatenRepository::class);
        $repository->deleteAll();
        $data = KabupatenDataset::get();
