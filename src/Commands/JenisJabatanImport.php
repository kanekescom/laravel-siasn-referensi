...
use Kanekescom\SiasnReferensi\Services\JenisJabatanDataset;

class JenisJabatanImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-jabatan-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis jabatan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisJabatanRepository::class);
        $repository->deleteAll();
        $data = JenisJabatanDataset::get();
