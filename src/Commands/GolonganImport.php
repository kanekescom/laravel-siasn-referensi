...
use Kanekescom\SiasnReferensi\Services\GolonganDataset;

class GolonganImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:golongan-ref';
     ...
     * @var string
     */
    protected $description = 'Import golongan reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(GolonganRepository::class);
        $repository->deleteAll();
        $data = GolonganDataset::get();
