...
use Kanekescom\SiasnReferensi\Services\JenisDiklatDataset;

class JenisDiklatImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-diklat-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis diklat reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisDiklatRepository::class);
        $repository->deleteAll();
        $data = JenisDiklatDataset::get();
