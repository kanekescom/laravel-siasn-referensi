...
use Kanekescom\SiasnReferensi\Services\JenisKpDataset;

class JenisKpImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'siasn-import:jenis-kp-ref';
     ...
     * @var string
     */
    protected $description = 'Import jenis kp reference from SIASN Reference datasets';
    ...
    {
        $start = now();
        $repository = app(JenisKpRepository::class);
        $repository->deleteAll();
        $data = JenisKpDataset::get();
